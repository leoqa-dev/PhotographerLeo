(function () {
    ...
    const translations = {
        en: {
            ...
            'hero.title': 'Commercial Video & Advertising Photography',
            'hero.copy': 'Professional visual production for brands, events, stores and destination portraits across the UAE and Guangzhou.',
        ...
        zh: {
            ...
            'hero.title': '商业录像与广告摄影',
            'hero.copy': '为阿联酋与广州的品牌、活动、门店、产品和目的地人像项目制作专业影像内容。',
            'hero.primary': '获取报价',
            'hero.secondary': '查看作品',
            'hero.proof1': '品牌视频',
            'hero.proof2': '活动记录',
